...
public class ByteIntUtil {
	...
	/**
	* This method returns an int value from the given byte array.
	* It does this by concatenating 4 bytes from the array starting
	* from the given index value.
	* <p>
	* For example: <p>{ (byte)0xF0, (byte)0xFF, (byte)0x00, (byte)0xF0}<p>
